import { ComponentType, APIMentionableSelectComponent, Snowflake, SelectMenuDefaultValueType, APISelectMenuDefaultValue } from 'discord-api-types/v10';

type MentionableDefaultValue = APISelectMenuDefaultValue<SelectMenuDefaultValueType.User | SelectMenuDefaultValueType.Role>;
type MentionableDefaultValueInput = { id: Snowflake; type: 'user' | 'role' };

export class V2MentionableSelectBuilder {
  public readonly id?: number;
  public readonly type: number = ComponentType.MentionableSelect;
  public readonly custom_id!: string;
  public readonly placeholder?: string;
  public readonly default_values?: MentionableDefaultValue[];
  ...
  public setDefaultValues(...values: (MentionableDefaultValueInput | MentionableDefaultValueInput[])[]): this {
  ...
  public toJSON(): APIMentionableSelectComponent & { required?: boolean } {
    ...
    } as APIMentionableSelectComponent & { required?: boolean };
  }
}