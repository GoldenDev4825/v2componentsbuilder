import { ComponentType, APIRoleSelectComponent, Snowflake, SelectMenuDefaultValueType, APISelectMenuDefaultValue } from 'discord-api-types/v10';

export class V2RoleSelectBuilder {
  public readonly id?: number;
  public readonly type: number = ComponentType.RoleSelect;
  public readonly custom_id!: string;
  public readonly placeholder?: string;
  public readonly default_values?: APISelectMenuDefaultValue<SelectMenuDefaultValueType.Role>[];
  ...
  public toJSON(): APIRoleSelectComponent & { required?: boolean } {
    ...
    } as APIRoleSelectComponent & { required?: boolean };
  }
}