import { ComponentType, APIChannelSelectComponent, Snowflake, ChannelType, SelectMenuDefaultValueType, APISelectMenuDefaultValue } from 'discord-api-types/v10';

export class V2ChannelSelectBuilder {
  public readonly id?: number;
  public readonly type: number = ComponentType.ChannelSelect;
  public readonly custom_id!: string;
  public readonly placeholder?: string;
  public readonly default_values?: APISelectMenuDefaultValue<SelectMenuDefaultValueType.Channel>[];
  ...
  public setChannelTypes(...channel_types: (ChannelType | ChannelType[])[]): this {
    Reflect.set(this, 'channel_types', channel_types.flat());
    return this;
  }
  ...
  public setDefaultValues(...channels: (Snowflake | Snowflake[])[]): this {
    const flattenedChannels = channels.flat();

    if (flattenedChannels.length > 25) {
      throw new Error("Cannot have more than 25 default values");
    }

    Reflect.set(this, 'default_values', 
      flattenedChannels.map((id) => ({
        id,
  ...
  public toJSON(): APIChannelSelectComponent & { required?: boolean } {
    ...
    } as APIChannelSelectComponent & { required?: boolean };
  }
}