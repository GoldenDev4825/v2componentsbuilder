...
exports.V2ChannelSelectBuilder = void 0;
const v10_1 = require("discord-api-types/v10");
class V2ChannelSelectBuilder {
    constructor() {
    ...
    setDefaultValues(...channels) {
        ...
        Reflect.set(this, 'default_values', flattenedChannels.map((id) => ({
            id,
            type: v10_1.SelectMenuDefaultValueType.Channel
        })));
        return this;
    }
    toJSON() {
...
exports.V2ChannelSelectBuilder = V2ChannelSelectBuilder;
