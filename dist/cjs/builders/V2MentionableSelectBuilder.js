...
exports.V2MentionableSelectBuilder = void 0;
const v10_1 = require("discord-api-types/v10");
class V2MentionableSelectBuilder {
    constructor() {
    ...
    setDefaultValues(...values) {
        ...
        Reflect.set(this, 'default_values', flattenedValues.map((val) => ({
            id: val.id,
            type: val.type === 'user'
                ? v10_1.SelectMenuDefaultValueType.User
                : v10_1.SelectMenuDefaultValueType.Role
        })));
        return this;
    }
    toJSON() {
...
exports.V2MentionableSelectBuilder = V2MentionableSelectBuilder;
